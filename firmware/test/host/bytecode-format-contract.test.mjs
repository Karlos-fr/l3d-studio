...
// ----------------------------------------------------------------------------
// Ces tests figent les limites de la phase 1 sans anticiper l'implementation
// TypeScript ou C++ des phases suivantes.
// ============================================================================
...
test("les erreurs bytecode utilisent la plage moins 300", () => {
  ...
  // Suite contractuelle attendue de moins 300 a moins 315.
  const expectedCodes = [];
