// ============================================================================
// NeoPixelDriver - Implémentation du pilote NeoPixel corrigé pour le Photon
// ----------------------------------------------------------------------------
// Ce fichier est une copie de référence de `firmware/neopixel-fix.cpp`. Il ne
// connaît ni les animations, ni Particle Cloud, ni le protocole L3D Studio.
// ============================================================================
